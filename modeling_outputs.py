...
class BaseModelOutputWithPastAndCrossAttentions(ModelOutput):
    ...
    attentions: Optional[Tuple[torch.FloatTensor]] = None
    cross_attentions: Optional[Tuple[torch.FloatTensor]] = None
    all_EElayer_exits: Optional[Tuple[torch.FloatTensor]] = None
    exit_layer: Optional[torch.FloatTensor] = None
    tot_select_loss: Optional[torch.FloatTensor] = None
    cost_computation: Optional[torch.FloatTensor] = None
...
class Seq2SeqLMOutput(ModelOutput):
    ...
    tot_select_loss: Optional[torch.FloatTensor] = None
    cost_computation:Optional[torch.FloatTensor] = None
    res_rougeL:Optional[torch.FloatTensor] = None
